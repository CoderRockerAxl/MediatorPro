...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/CoderRockerAxl/A_Category"
  ...
  s.source       = { :git => "https://github.com/CoderRockerAxl/A_Category.git", :tag => s.version.to_s }
